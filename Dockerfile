...
## $ docker buildx build --provenance=true --sbom=true --platform linux/amd64,linux/arm64 -t digiserve/ab-definition-manager:master --push .
...
LABEL org.opencontainers.image.title="Definition Manager" \
   org.opencontainers.image.description="Service to manage definitions for a running AppBuilder platform" \
